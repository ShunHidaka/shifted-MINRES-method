#include "../c/function_sminres.h"
char *FNAME = "/home/stern/multi/data/PPE3594.csr";
//char *FNAME = "/home/stern/multi/data/CLIQ55296std.csr";
//char *FNAME = "/home/stern/multi/data/VCNT900h.csr";
//char *FNAME = "/home/stern/multi/data/VCNT10800h.csr";
int M = 10;
...
int main(void){
  ...
  fprintf(stdout, "%s\n", FNAME);
  status[0]=1; status[1]=1; status[2]=20;
...
/*
gcc sample1.c ../c/function_sminres.c -lm -lgfortran -lblas -llapack
*/
